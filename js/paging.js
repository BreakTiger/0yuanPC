(function($, window, document) {
    ...
    Paging.prototype = {
        ...
        createDom: function() {
            ...
            that.options.jump ? jumpDom = '到第<input type="text" placeholder="1" class="jump-text jumpText" >页<button type="button" class="jump-button" >确定</button>' : jumpDom = '';
            content = '<div class="pagger-box flex row fl-align">' +
